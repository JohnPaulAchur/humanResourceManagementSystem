    ...
    $employeeId = $_POST['empid'];
     if(empty($employeeId)){
        echo "<script>alert('Please Select Atleast One Person'); </script>";
            ...
            echo "<script>alert('Member(s) Added Successfully'); window.location='group-members?id=".$id."'; </script>";
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title"><i class="fa fa-plus text-primary"></i> Add Members</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                           ...
                           <form method="POST">
                              <div class="form-group">
                                 ...
                                 <!-- <input type="text" readonly name="group" value="<?php echo $groupName; ?>" class="form-control"> -->
                                 <h4>Group Name: <?php echo $groupName; ?></h4>
                              </div>
                                ...
                                <div class="iq-card-header d-flex justify-content-between">
                                <div class="iq-header-title">
                                    <h6 class="card-title">Select New Memebers  To Add</h6>
                                </div>
                                </div>
                                <div class="iq-card-body">
                                ...
                                $fetching = dbConnect()->prepare("SELECT * FROM employee WHERE id NOT IN (SELECT employee_id FROM group_members WHERE group_id=?)");
                                $fetching->execute([$id]);
